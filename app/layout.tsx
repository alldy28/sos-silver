...
export const metadata: Metadata = {
  // Metadata Dasar
  title: {
    default: "Sossilver - Investasi Perak Murni 999.9 Bersertifikat",
    template: "%s | Sossilver",
  },
  description:
    "Investasi perak batangan murni 999.9 bersertifikat resmi. Pilihan terpercaya untuk melindungi dan mengembangkan nilai aset Anda dengan aman.",
  ...
  openGraph: {
    type: "website",
    locale: "id_ID",
    url: "https://sossilver.co.id", // GANTI dengan URL domain Anda
    siteName: "Sossilver",
    title: "Sossilver - Investasi Perak Murni 999.9 Bersertifikat",
    description:
      "Investasi perak batangan murni 999.9 bersertifikat resmi. Pilihan terpercaya untuk melindungi dan mengembangkan nilai aset Anda dengan aman.",
    images: [
      {
        url: "https://sossilver.co.id/gambar.png", // GUNAKAN URL LENGKAP (bukan relatif)
        width: 1200,
        height: 630,
        alt: "Sossilver - Perak Batangan Murni 999.9 Bersertifikat",
        type: "image/png",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Sossilver - Investasi Perak Murni 999.9 Bersertifikat",
    description:
      "Investasi perak batangan murni 999.9 bersertifikat resmi. Lindungi nilai aset Anda dengan aman.",
    images: ["https://sossilver.co.id/gambar.png"], // GUNAKAN URL LENGKAP
    creator: "@sossilver", // Jika ada akun Twitter
  },
...
function WhatsAppBubble() {
  const phoneNumber = "628131114586"; // Format: 62 + nomor tanpa 0
  const message = "Halo SoS Silver, saya tertarik dengan produk perak Anda.";
  ...
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-green-500 rounded-full shadow-lg transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2"
